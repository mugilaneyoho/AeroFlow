            ...
            {meetings.map((meeting) => (
                <div key={meeting.id} className="w-150 shadow-[0px_0px_14px_0px_#76153C_inset] rounded-2xl p-8 pb-3 pt-4">
                    ...
                    <div className="flex gap-5 m-3">
                        <button onClick={() => setSelectedMeeting(meeting)} className="flex flex-1 gap-3 border-[0.5px] border-[#76153C] p-2 text-center justify-center rounded-2xl w-full cursor-pointer">
