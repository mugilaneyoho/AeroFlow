    ...
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center gap-12 bg-[#F4F4F4] px-8">
      ...
      <form onSubmit={handleLogin}
        ...
        <div className="mt-3">
          ...
          <button type="submit" className="w-full p-2 mt-3 text-center shadow-[0px_0px_14px_0px_#2D216140] rounded-[5px] cursor-pointer" style={{ backgroundColor: COLORS.primary_blue, color: COLORS.secondary_white }}>
            <p>Login</p>
          </button>
        </div>
      </form>
