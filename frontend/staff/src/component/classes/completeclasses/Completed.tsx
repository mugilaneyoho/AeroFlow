...
const Completed = () => {
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 p-3  gap-3">
  ...
  <div className="flex items-center border p-1 rounded-[5px]">
    ...
    <p style={{color:COLORS.primary_violet,borderColor:COLORS.border_color }} className='text-sm '>{item.note1}</p>
  </div>
  ...
  <div className="flex items-center border p-1 rounded-[5px]">
    <img src={noteicon} alt='noteicon' />
    <p style={{color:COLORS.primary_violet,borderColor:COLORS.border_color }} className='text-sm '>{item.note3}</p>
  </div>
  <div className="flex items-center border p-1 rounded-[5px]">
    <img src={noteicon} alt='noteicon' />
    <p style={{color:COLORS.primary_violet,borderColor:COLORS.border_color }} className='text-sm '>{item.note4}</p>
  </div>
</div>
  </div>
