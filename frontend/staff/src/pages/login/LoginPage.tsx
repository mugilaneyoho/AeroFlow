      ...
      className="shadow-[0px_0px_14px_0px_#2D216140] p-8 rounded-[10px] w-full max-w-md bg-white ">
        <div className="flex flex-col items-center justify-center ">
          <h1 style={FONTS.tittle}>
            Welcome to{" "}
            <strong style={{ color: COLORS.primary_violet}}>IIMS</strong>
          </h1>
        ...
        <div className="mt-3 ">
          ...
          className="p-2 w-full text-center shadow-[0px_0px_14px_0px_#2D216140]" style={{backgroundColor:COLORS.primary_violet,color:COLORS.secondary_white}}>
        ...
        <div className="mt-3">
          ...
          <div className="relative">
            ...
            <div className="p-2 mt-3 text-center shadow-[0px_0px_14px_0px_#2D216140] rounded-[5px]"  style={{backgroundColor:COLORS.primary_violet,color:COLORS.secondary_white}}>
