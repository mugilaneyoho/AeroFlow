  ...
  return (
    <div className={`shadow-[0px_4px_14px_0px_#2516F8] grid ${status === 'INTERESTED'? 'grid-cols-4' : 'grid-cols-3'}  gap-10 rounded-2xl py-4 pl-16 items-center`}>
        ...
        <div className='flex flex-col justify-between items-center gap-10'>
            <div onClick={()=>navigate('/admit')} className='shadow-[0px_0px_14px_0px_#2516F8_inset] px-6 py-2 font-semibold rounded-xl hover:bg-[#2516F8] hover:text-white cursor-pointer'>Go To Admited</div>
