...
const activelog_module_1 = require("./activelog/activelog.module");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [activitylog_1.ActivityLogEntity, notify_1.NotificationEntity],
                synchronize: true,
            }),
            activelog_module_1.ActivelogModule,
